...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(LabelType tickLabelType READ tickLabelType WRITE setTickLabelType)     //****** sila
...
public:
  ...
  */
  ...
  LabelType tickLabelType() const { return mTickLabelType; }                //*** sila
